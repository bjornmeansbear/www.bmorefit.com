...
$geo = new geo;
$geo->root = "/"; // Full server path (include trailing slash)
...
$snippet = <<<EOD
<ul>
  <li>Contact our <a href="mailto:sales@company.com">test@alexroper.com</a>.</li>
...
<script>
document.write('<p style="color:#f0f;"><strong>javascript is on!</strong></p>');
</script>
